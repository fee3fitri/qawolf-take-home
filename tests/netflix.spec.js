...
// 1. Failed log in scenario when email/password combination is invalid
test('failed log in', async ({ page }) => {
  ...
  await page.getByLabel('Email or phone number').fill('safitri');
...
// 2. Successful log in scenario when email/password combination is valid
